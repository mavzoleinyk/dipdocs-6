  ...
  <div class="col-lg-8 blog__content mb-72">
    <div class="content-box">           
      ...
      <article class="entry mb-0">
        ...
        <?php if( is_page(10) ) : get_template_part('parts/section', 'number'); endif;?>
        <?php get_template_part('parts/section', 'lastanswer');?>
        <?php if( is_page(10) ) : get_template_part('parts/section', 'skills'); endif;?>
        <?php if( is_page(10) ) : get_template_part('parts/section', 'team'); endif;?>
        ...
        <?php get_template_part('parts/section', 'advantage');?>
